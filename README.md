...
- 🚀 **Multi-Language Support**: Generate SDKs for Go, Python, PHP, TypeScript/JavaScript, and Ruby
- 📦 **Template-Based Generation**: Clean, maintainable template system
- 🔧 **Language Version Configuration**: Specify target language versions (Go 1.24/1.25, Python 3.11-3.14, PHP 8.0-8.3, TypeScript 4.9-5.5, Ruby 3.0-3.3)
- 📌 **SDK Version Management**: Automatic version extraction from OpenAPI schema
- 🎨 **Code Formatting**: Automatic formatting for generated code (gofmt, black/autopep8, RuboCop)
...
### ✅ Ruby
- Versions: 3.0, 3.1, 3.2, 3.3 (Default: 3.0)
...
- `--php-version`: PHP version (e.g., `8.0`, `8.1`, `8.2`, `8.3`). Default: `8.1`
- `--typescript-version` / `--ts-version`: TypeScript version (e.g., `4.9`, `5.0`, `5.1`). Default: `5.0`
- `--ruby-version` / `--rb-version`: Ruby version (e.g., `3.0`, `3.1`, `3.2`, `3.3`). Default: `3.0`
...
- ✅ API methods organized by tags
- ✅ `version.rb` with SDK version constant
