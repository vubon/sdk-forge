...
func generateSDKForLanguage(lang, outputPath, sdkName, httpLib string, doc interface{}, cmd *cobra.Command) error {
	...
	switch lang {
	case langPython:
		return generator.GeneratePythonSDK(outputPath, sdkName, httpLib, doc, pythonVer, sdkVerStr, generateTests)
	case langGo:
		return generator.GenerateGoSDK(outputPath, sdkName, httpLib, doc, goVer, sdkVerStr, generateTests)
	case "php":
